...
<table>
  ...
  <tr>
    <td style="background:url(images/user_index_tab_bg.gif) left top repeat-y; text-align:right; padding-right:20px;">·<a href="outbox.htm" class="a_14c_blue1">进入发件箱</a>&nbsp;&nbsp;·<a href="send_message.htm" class="a_14c_blue1">编写新信息</a></td>
  </tr>
</table>
</div>
