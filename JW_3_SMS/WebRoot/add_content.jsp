...
<table style="margin-left:-50px;margin-top:-20px">
  ...
  <tbody><tr>
    ...
    <td width="345" align="left"><input type="text" style="width:200px; border:1px #CCCCCC solid; background:#F5F5F5; float:left;"><input type="image" src="images/address_box_ico.gif" style=" float:right;"></td>
  </tr>
  <tr>
    <td align="right" valign="top" class="text_14c_black">信息内容：</td>
    <td align="left"><textarea style="width:200px; height:100px;  "></textarea></td>
  </tr>
  <tr>
    <td align="right" valign="top" class="text_14c_black">即时发送：</td>
    <td align="left"><select style="width:80px;">
    <option>否</option>
  </select></td>
  </tr>
  <tr>
    <td align="right" valign="top" class="text_14c_black">&nbsp;</td>
    <td align="left"><button style="width:75px; height:25px; border:0px; background:none; cursor:hand;"><img src="images/send_button.gif"></button>&nbsp;&nbsp;<button style="width:75px; height:25px; border:0px; background:none; cursor:hand;"><img src="images/save02_button.gif"></button></td>
  </tr>
